...
import type { AppTab, InventoryEvent, Product, ProductAnalysis, ProductFormValues, PurchaseRecord } from '../types';
...
export default function DashboardScreen() {
  ...
  useEffect(() => {
    ...
    async function hydrate() {
      const [loadedProducts, loadedPurchaseRecords, loadedInventoryEvents] = await Promise.all([
        loadProducts(),
        loadPurchaseRecords(),
        loadInventoryEvents()
      ]);
  ...
  function renderActiveScreen() {
    ...
    if (activeTab === 'settings') {
      return <UnavailableScreen title="Settings" subtitle="Profile, app preferences, export, and reset tools will be added in a future version." icon="⚙" />;
    }
    ...
    return (
      <HomeScreen
        ...
        totalTrackedStock={totalTrackedStock}
