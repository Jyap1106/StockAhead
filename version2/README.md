...
- Frozen bottom tab bar with 5 functions:
  ...
  - Add Product modal
  - Calendar
  - Settings unavailable placeholder
- Home page starts with Next Event Summary
- Only sale dates with products are shown in the next-event list
- Future sale groups are collapsed until tapped
...
Extract the zip, open the extracted folder, and upload the contents into the root of your GitHub repository.
